...
const officials = [
  ["DF", "Shri. Sadanand Date", "Director General of Police (DGP),Maharashtra"],
  ["ES", "Shri. Vishwas Nangare Patil", "Additional Director General of Police (ADGP), Maharashtra"],
  ["SP", "Shri. Dattatray Shinde", "Inspector General of Police (IGP), Maharashtra"],
  ["AS", "Sanjeev K. Singhal", "Deputy Inspector General of Police (DIG), Maharashtra"],
];
